...
def evaluate_holt_winter(data):
    ...
    Train = data.loc[:data.index[train_slider]].dropna()
    Test = data.loc[data.index[train_slider]:data.index[train_slider + test_slider]].dropna()
...
evaluate_holt_winter(Reliance4)
